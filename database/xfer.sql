...
INSERT INTO nominated_individual (action_code, last_updated, name, provider_id, regulated_activity_number)
SELECT DISTINCT
'I', now(),
nominated_individual,
provider_id,
regulated_activity_id
FROM providerprofile.nominated_individual_a
LIMIT 100;
