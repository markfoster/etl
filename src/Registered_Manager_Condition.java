...
public class Registered_Manager_Condition implements java.io.Serializable, CQC_Entity {
    ...
    public Registered_Manager_Condition(String providerId, String locationId, String registeredManagerId, String regulatedActivity, String conditionId, String text,
	...
	if ((other == null))
	    return false;
	if (!(other instanceof Registered_Manager_Condition))
	    return false;
