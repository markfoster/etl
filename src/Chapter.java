...
public class Chapter implements java.io.Serializable, CQC_Entity {
	...
	return ((this.getProviderId() == castOther.getProviderId()) || (this.getProviderId() != null && castOther.getProviderId() != null && this.getProviderId().equals(
	        ...
	        && ((this.getChapterNumber() == castOther.getChapterNumber()) || (this.getChapterNumber() != null && castOther.getChapterNumber() != null && this
	                .getChapterNumber().equals(castOther.getChapterNumber())));
    }
