 ...
 */
public class Nominated_Individual implements java.io.Serializable, CQC_Entity {
    ...
    public Nominated_Individual(String providerId, String regulatedActivityNumber) {
	...
	if ((other == null))
	    return false;
	if (!(other instanceof Nominated_Individual))
	    return false;
	Nominated_Individual castOther = (Nominated_Individual) other;
