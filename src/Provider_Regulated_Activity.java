 ...
 */
public class Provider_Regulated_Activity  implements java.io.Serializable {
    ...
    public Provider_Regulated_Activity(String providerId, String regulatedActivityNumber, String actionCode, Date lastUpdated) {
       this.providerId = providerId;
       this.regulatedActivityNumber = regulatedActivityNumber;
