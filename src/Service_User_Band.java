...
public class Service_User_Band implements java.io.Serializable, CQC_Entity {
	...
	if ((other == null))
	    return false;
	if (!(other instanceof Service_User_Band))
	    return false;
	...
	return ((this.getProviderId() == castOther.getProviderId()) || (this.getProviderId() != null && castOther.getProviderId() != null && this.getProviderId().equals(
	        ...
	        && ((this.getServiceUserBandId() == castOther.getServiceUserBandId()) || (this.getServiceUserBandId() != null && castOther.getServiceUserBandId() != null && this
	                .getServiceUserBandId().equals(castOther.getServiceUserBandId())));
    }
