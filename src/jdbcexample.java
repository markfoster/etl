...
public class jdbcexample {
	...
	/**
	 * Object a = context.getBean("sysprops"); System.out.println(a);
	 * 
	...
	// String s = (String)jt.queryForObject("select * from provider",
	// String.class);

	/**
	 * List<String> postcodes = jt.query("select postcode from provider",
	 * new RowMapper() { public Object mapRow(ResultSet resultSet, int i)
	 * throws SQLException { return resultSet.getString(1); } });
	 * System.out.println(postcodes);
	 **/

	/**
	 * CustomerDAO customerDAO = (CustomerDAO)
	 * context.getBean("customerDAO"); Customer customer = new Customer(1,
	 * "mkyong",28); customerDAO.insert(customer);
	 * 
