...
public class WatchDog {
	...
	int rows = jt.update("INSERT INTO watchdog (uid, type, message, severity, link) VALUES (?, ?, ?, ?, ?)", new Object[] { new Integer(runId), WatchDog.ellipsize(type, 16),
	        message, new Integer(severity), env });
