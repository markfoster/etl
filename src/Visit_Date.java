...
public class Visit_Date implements java.io.Serializable, CQC_Entity {
	...
	if ((other == null))
	    return false;
	if (!(other instanceof Visit_Date))
	    return false;
	...
	return ((this.getProviderId() == castOther.getProviderId()) || (this.getProviderId() != null && castOther.getProviderId() != null && this.getProviderId().equals(
	        ...
	        && ((this.getVisitDate() == castOther.getVisitDate()) || (this.getVisitDate() != null && castOther.getVisitDate() != null && this.getVisitDate().equals(
	                castOther.getVisitDate())));
    }
    ...
    public String getPK() {
	return String.format("%s/%s/%s/%s/%s", getProviderId(), getLocationId(), getOutcomeNumber(), getReportPublicationDate(), getVisitDate());
    }
